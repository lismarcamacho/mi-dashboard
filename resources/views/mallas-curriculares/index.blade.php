                ...
                <tr>
                    ...
                    <td>
                        @if ($mallaCurricular->especialidad)
                            ...
                            {{ $mallaCurricular->especialidad->nombre_especialidad }} {{-- Asumiendo que la columna se llama 'nombre' en Especialidad --}}
                        @else
                            N/A
                        @endif
                    </td>
                    ...
                    <td>{{ $mallaCurricular->minimo_aprobatorio }}</td>
                    ...
                    <td><a href="{{ route('mallas-curriculares.edit', $mallaCurricular->id) }}"
                        ...
                        <form style="display: inline" action="{{ route('mallas-curriculares.destroy', $mallaCurricular->id) }}"
