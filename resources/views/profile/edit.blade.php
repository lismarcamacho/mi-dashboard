    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('profile.update', $user) }}" method="POST">
                ...
                <x-adminlte-input class="col-md-12" id="name" name="name" label="Nombre de Usuario:"
                ...
                <x-adminlte-input class="col-md-12" id="email" name="email" label="Correo Electrónico:"
                ...
                <button type="submit" class="btn btn-primary" id="Edit">Guardar Cambios</button>
...
@section('css')
    ...
    <style>
        .card {
            margin-right: 60%;
            margin: auto;
            /* Añade margen arriba y abajo, y centra horizontalmente */
            max-width: 600px;
            /* O el ancho máximo que desees para el contenedor */
            width: 90%;
            /* O un porcentaje del ancho para hacerlo responsivo */
        ...
        .card-body {
            ...
            /* width: 400px;  */
            margin: 0em;
            /* Para centrar el formulario si es necesario */
            margin-bottom: 0px;
            margin-left: 20%;
            margin-right: 20%;
        }
        ...
        .form-group {
            margin-bottom: 18px;
            /* Reduce el margen inferior del grupo */
        }

        .form-group label {
            display: block;
            margin-bottom: 2px;
            /* Reduce el margen inferior de la etiqueta */
        }
        ...
        .form-control {
            width: 300px;
            /* Ajusta este valor para el ancho deseado */
