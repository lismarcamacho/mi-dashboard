...
@section('preloader')
    ...
    <h4 class="mt-4 text-dark">Cargando Formulario Editar Titulo..</h4>
@stop
...
@section('content')
    ...
    <p> Modifique la información del Titulo</p>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('titulos.update', $titulo) }}" method="POST" id=FormEdit>
                ...
                <div class="col-md-12">
                    <x-adminlte-input class="col-md-6" name="nombre" label="Nombre"
                        label-class="text-lightblue" value="{{ $titulo->nombre }}">
                ...
                <div class="col-md-12">
                    <x-adminlte-input class="col-md-6" name="duracion" label="Duracion" label-class="text-lightblue"
                        value="{{ $titulo->duracion }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                                <i class=" text-darkblue"></i>
                                <!-- @ error('descripcion')
                ...
                <a href="{{ route('titulos.index') }}" class="btn btn-secondary">Regresar</a>
